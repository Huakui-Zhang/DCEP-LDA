# -*- coding: utf-8 -*-
"""
处理NeuroNER产生的BRAT格式的文件，对识别出的实体使用下划线连接，
...
dataset = '20news' # 20news bbc reuters
data_dir = './%s_data'%dataset

# read file generated by NeuroNER
with open(os.path.join(data_dir, 'NER_result.txt'), 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
with open(os.path.join(data_dir, 'ne.txt'), 'w', encoding = 'utf-8') as f:
    f.write('\n'.join(news))